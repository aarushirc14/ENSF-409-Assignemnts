...
public class NewFeatureTest {
    ...
    @Test
    /*
     * Both constructors and both addVisitorReservation() should throw an
     * IllegalArgumentException for an invalid licence as defined in the Parking
     * class.
     */
    public void testThrowsExceptionWithInvalidLicence() {
        ...
        assertTrue(
                "VisitorParking 1-argument constructor did not throw IllegalArgumentException when given invalid licence",
                passed);
        ...
        assertTrue(
                "VisitorParking 2-argument constructor did not throw IllegalArgumentException when given invalid licence",
                passed);
        ...
        assertTrue(
                "VisitorParking 1-argument addVisitorReservation did not throw IllegalArgumentException when given invalid licence",
                passed);
        ...
        assertTrue(
                "VisitorParking 2-argument addVisitorReservation did not throw IllegalArgumentException when given invalid licence",
                passed);
    }

    @Test
    /*
     * The constructor and addVisitorReservation() should throw an
     * IllegalArgumentException when provided with a date in the past.
     */
    public void testThrowsExceptionWithInvalidDate() {
        ...
        assertTrue("VisitorParking 2-argument constructor did not throw IllegalArgumentException when given past date",
                passed);
        ...
        assertTrue(
                "VisitorParking 2-argument addVisitorReservation did not throw IllegalArgumentException when given past date",
                passed);
    }

    @Test
    /*
     * addVisitorReservation() should throw an IllegalArgumentException when a
     * licence is reserved.
     */
    public void testThrowsExceptionWithOverlapDate() {
        ...
        assertTrue(
                "VisitorParking 2-argument addVisitorReservation did not throw IllegalArgumentException when two reservations for the same licence include the same day",
                passed);
        ...
        assertTrue(
                "VisitorParking 1-argument addVisitorReservation did not throw IllegalArgumentException when two reservations for the same licence include the same day",
                passed);
    }

    @Test
    /*
     * addVisitorReservation() should throw an exception when trying to make a third
    ...
    public void testThrowsExceptionTooManyPermits() {
        ...
        assertTrue(
                "VisitorParking 2-argument addVisitorReservation did not throw IllegalArgumentException when attempting a third reservation on the same date",
                passed);
        ...
        assertTrue(
                "VisitorParking 1-argument addVisitorReservation did not throw IllegalArgumentException when attempting a third reservation on the same date",
                passed);
    }

    /*
     * It should be possible to add three reservations when the first and third
     * don't overlap in time with each other, and the second overlaps with both.
     */
    @Test
    public void testAllowsNonOverlappingReservations() {
        ...
        assertTrue(
                "VisitorParking addVisitorReservation threw an exception when attempting a third non-overlapping reservation",
                passed);
    }

    /*
     * It should be possible to make two reservations for a single licence, where
     * the second reservation starts the day after the first reservation ends.
     */
    @Test
    public void testAllowsSequentialReservationsForLicence() {
        ...
        assertTrue(
                "VisitorParking addVisitorReservation threw an exception when attempting non-overlapping reservations for one licence",
                passed);
    }

    /*
     * It should be possible to make a lot of reservations, and those reservations
     * don't have to be made in order.
     * When making reservations and using licenceIsRegisteredForDate(), licences are
     * standardized, consistent with Parking
     */
    @Test
    public void testManyReservations() {
        ...
        // Reservations are being made out of order to ensure there is no limitation
        // related to ordering
        ...
        assertTrue(
                "VisitorParking addVisitorReservation() didn't correctly add two licences (one requiring standardization) across multiple dates",
                success);
    }

    /*
     * getLicencesRegisteredForDate() should give all licences registered for today
    ...
    public void testLicencesRegisteredForToday() {
        ...
        assertTrue("VisitorParking 0-argument getLicencesRegisteredForDate() does not include expected licence",
                (success1 && success2));
        assertTrue(
                "VisitorParking 0-argument getLicencesRegisteredForDate() does not include only one instance of expected licence",
                (count <= 2));
        assertTrue("VisitorParking 0-argument getLicencesRegisteredForDate() includes unexpected entry", noOtherData);
    }

    /*
     * getLicencesRegisteredForDate() should give all licences registered for a
     * specified day.
     */
    @Test
    public void testLicencesRegisteredForDate() {
        ...
        // Add some reservations, get a list of all reservations for the overlapping
        // date
        ...
        assertTrue("VisitorParking 1-argument getLicencesRegisteredForDate() does not include expected licence",
                (success1 && success2));
        assertTrue(
                "VisitorParking 1-argument getLicencesRegisteredForDate() does not include only one instance of expected licence",
                (count <= 2));
        assertTrue("VisitorParking 1-argument getLicencesRegisteredForDate() includes unexpected entry", noOtherData);
    }

    /*
     * Each reservation is made for the day of the reservation, plus two additional
     * days only.
     */
    @Test
    public void testReservationsForThreeDaysOnly() {
        ...
        assertTrue("VisitorParking does not register reservation for three days",
                (successDay1 && successDay2 && successDay3));
    }

    /*
     * The method getAllDaysLicenceIsRegistered() returns an ordered list of the
     * entire period for which a licence is registered.
     */
    @Test
    public void testAllDaysLicenceIsRegistered() {
        ...
        String expectedString = "[2046-05-15, 2046-05-16, 2046-05-17, 2046-05-30, 2046-05-31, 2046-06-01]"; // Used to
                                                                                                            // confirm
                                                                                                            // list is
                                                                                                            // ordered
        ...
        // Check that for each day (day1 and day2), the first, second, and third days
        // are included, and no other days are included
        while (iter.hasNext()) {
        ...
        assertTrue(
                "VisitorParking getAllDaysLicenceIsRegistered() does not contain all days the licence is registered (first registration)",
                (success1 && success2 && success3));
        assertTrue(
                "VisitorParking getAllDaysLicenceIsRegistered() does not contain all days the licence is registered (second registration)",
                (success4 && success5 && success6));
        assertTrue("VisitorParking getAllDaysLicenceIsRegistered() contains days which are not registered",
                onlyExpectedDays);
        assertEquals("VisitorParking getAllDaysLicenceIsRegistered() does not return an ordered list", expectedString,
                actualDates.toString());
    }

    /*
     * The method getStartDaysLicenceIsRegistered() returns an ordered list
     * consisting of the starting days which a licence is registered.
     */
    @Test
    public void testStartDaysLicenceIsRegistered() {
        ...
        // Check that each day (registeredDates 1, 2, and 3) is present, and no other
        // days are included
        while (iter.hasNext()) {
            LocalDate tmp = iter.next();
            if (tmp.equals(registeredDate1)) {
        ...
        assertTrue("VisitorParking startDaysLicenceIsregistered() does not contain all starting registration dates",
                (success1 && success2 && success3));
        assertTrue("VisitorParking startDaysLicenceIsregistered() contains days which are not registered",
                onlyExpectedDays);
        assertEquals("VisitorParking startDaysLicenceIsregistered() did not return an ordered list", expectedString,
                actualDates.toString());
    }
    ...
    public void testOnlyOneResidentLicence() {
        ...
        assertTrue("addOrReplaceResidentLicence() does not throw an IllegalArgumentException with invalid input",
                exceptionThrown);
    }
    ...
    public void testAddViaHouseholdParking() {
        ...
        assertTrue("HouseholdParking getVisitors() doesn't return a VisitorParking object",
                (vp instanceof VisitorParking));
    ...
    /*
     * Check all the getters and boolean methods in VisitorParking can be accessed
     * via HouseholdParking.
    ...
    public void testAccessViaHouseholdParking() {
        ...
        // Access data via the HouseholdParking object
        // getLicencesRegisteredForDate(commonDate)
        ...
        assertTrue("HouseholdParking 1-argument getLicencesRegisteredForDate() does not include expected licence",
                (success1 && success2));
        assertTrue(
                "HouseholdParking 1-argument getLicencesRegisteredForDate() does not include only one instance of expected licence",
                (count <= 2));
        ...
        assertEquals("HouseholdParking 1-argument getLicencesRegisteredForDate() does not contain expected data",
                "[CAT]", todayString);

        // Access data via HouseholdParking object, licenceIsRegisteredForDate()
        boolean found0 = hp.licenceIsRegisteredForDate(licence3);
        assertTrue("HouseholdParking 0-argument licenceIsRegisteredForDate() does not return true for expected licence",
                found0);
        boolean found1 = hp.licenceIsRegisteredForDate(licence1, date1);
        assertTrue("HouseholdParking 1-argument licenceIsRegisteredForDate() does not return true for expected licence",
                found1);
        ...
        // Check that getStartDaysLicenceIsRegistered() and
        // getAllDaysLicenceIsRegistered() work with access via HouseholdParking
        ...
        assertEquals("HouseholdParking getStartDaysLicenceIsRegistered() does not return a correct ordered list",
                expectedStartDays, actualStartDays);
        assertEquals("HouseholdParking getAllDaysLicenceIsRegistered() does not return a correct ordered list",
                expectedAllDays, actualAllDays);
    }
}
