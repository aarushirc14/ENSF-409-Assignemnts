...
public class BonusTest {
    ...
    public void bonusValuesAreReverseTreeSetByLicenceONE() {
        ...
        assertEquals("The values stored in parkingRecord are not stored in a reverse-ordered TreeSet per licence",
                values[0], values[1]);
    }
    ...
    public void bonusValuesAreTreeSetsONE() {
        ...
        assertEquals("The values stored in parkingRecord do not match the first days of all reservations", values[0],
                values[1]);
    }
    ...
    /*
     * parkingRecord values are stored in a reverse-ordered TreeSet, one per
     * licence.
     */
    private static String[] valuesAreReverseTreeSetsByLicence() {
        ...
        // Add in values for another licence - these should not be included in the data
