...
public class Parking {
    ...
    public static String standardizeAndValidateLicence(String licence) throws IllegalArgumentException {
        // Standardize licence by making all upper case and removing spacing &
        // punctuation
        licence = licence.toUpperCase();
        licence = licence.replaceAll("[^\\w]", "");

        // Alberta licence plates can be up to 7 characters consisting of only letters
        // and
        // numbers. Our parking system doesn't allow licence plates from other parts of
        // Canada,
